            ...
            <table class = "bangdiem-l">
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            @if ($key->Status == 1)
                            <output type="button" name="DotXets_MaDX" id="dot-{{ $key->MaDX }}" IDdotxet="{{ $key->MaDX }}" class="btn btn-primary rgdx" status="1">Đăng ký</output>
                            @else
                            <output type="button" name="DotXets_MaDX" id="dot-{{ $key->MaDX }}" IDdotxet="{{ $key->MaDX }}" class="btn btn-primary rgdx" status="0">Chưa mở</output>
                            @endif
                        </div>
                    </td>
                </tr>
            ...
            $(".rgdx").each(function(){
                $(this).on("click", function(){
                    if($(this).attr("status") != 0){
                        var DotXets_MaDX = $(this).attr("IDdotxet");
